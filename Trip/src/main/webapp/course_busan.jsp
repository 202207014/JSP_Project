...
<body>
	...
	try {
		...
		// 쿼리: places 테이블에서 'busan_'으로 시작하는 장소(이름, 타입)만 조회
	...
	jsPlaces.append("]");
	// 최종 결과 예: [{name:'해운대 해수욕장', type:'해수욕장'}, ...]
	%>
...
// 카카오 지도 객체 생성 및 초기화 (부산 중심 좌표 설정)
var map = new kakao.maps.Map(document.getElementById('map'), {
	center:new kakao.maps.LatLng(35.1807,129.0753), // 지도 초기 중심 (부산 시내 인근)
	level:10 // 지도 확대 레벨
});
